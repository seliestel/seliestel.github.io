...
## Activity 9.1 — The Semiotic Field Study (Portfolio) ★

<div class="meta">
<span class="tag type">Individual (or Pair)</span>
<span class="tag time">2–3 weeks (project)</span>
<span class="tag tech">Phone; slides or doc</span>
</div>

<p class="concept">Integrates: sign types (Ch 4), codes (Ch 6), communication (Ch 5), cultural/applied/visual/social semiotics (Ch 7).</p>

Choose **one Thai "site of meaning"** and produce a 1,500–2,000-word illustrated analysis (or a narrated slide deck). Good choices:

- a **market**, a **temple**, a **7-Eleven**, a **BTS station**, a **spirit house**, a **street-food cart**, a **school assembly**, a **festival** (Songkran, Loi Krathong), a **brand**, a **lakorn episode**.
...
## Activity 9.2 — Concept Map of the Whole Discipline
...
- Compare maps between groups; differences reveal genuine conceptual choices, not just errors.
</details>
</div>

<div class="activity" markdown="1">

## Activity 9.3 — The Arc of the Discipline: A Reflective Essay

<div class="meta">
<span class="tag type">Individual</span>
<span class="tag time">Take-home essay</span>
</div>

<p class="concept">Integrates: the historical and intellectual trajectory of semiotics (§2, §9 conclusion).</p>
...
## Activity 9.4 — The Sign Clinic (Peer Review)
