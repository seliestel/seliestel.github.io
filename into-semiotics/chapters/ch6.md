...
permalink: /into-semiotics/chapters/ch6/
title: Codes and Sign Systems
chapter: 6
order: 6
count: 5
book_sections: "§6.1–6.8"
...
| Code | Digital / Analog | Natural / Artificial | Strong / Weak | Cultural / Subcultural |
|---|---|---|---|---|
| Traffic lights | | | | |
| The <em>wai</em> (height of hands) | | | | |
| Temple dress code | | | | |
| LINE stickers | | | | |
| Muay Thai <em>wai khru</em> ritual | | | | |
| Gamer / e-sports slang | | | | |

<details class="notes" markdown="1">
<summary>Instructor notes &amp; answer key</summary>

- Traffic lights: digital, artificial, strong, cultural. Wai: **analog** (hand height varies continuously with the status of the addressee — a lovely analog example), natural-ish/traditional, medium-strong, cultural. Temple dress code: analog-ish, conventional, medium, cultural. LINE stickers: digital units but with weak, negotiated meanings, artificial, weak, cultural→subcultural. Wai khru: analog, traditional, fairly strong (ritualised), cultural/subcultural. Gamer slang: digital-ish, artificial, weak, **subcultural**.
- The wai is the star: hand height is *analog* (§6.2), and its meaning depends entirely on relative status — a bridge to **social semiotics** (§7.4).
...
## Activity 6.2 — Dressing the Occasion: A Paradigm of Attire

<div class="meta">
<span class="tag type">Pair</span>
...
- Temple: covered shoulders/knees vs shorts/sleeveless (the latter signals disrespect or ignorance of the code). Mourning: **black** (and the marked wrongness of bright colours). Songkran: light, water-ready, often floral shirts.
- This is Saussure's **value** (§3.6) re-applied to a cultural code: black "means" mourning largely by *not being* the everyday palette. Also seeds **connotation** (6.4) and **myth** (6.7).
- Sensitivity: national mourning attire is tied to the monarchy; keep it factual and respectful, framing it as how a colour code works.
</details>
</div>

<div class="activity" markdown="1">

## Activity 6.3 — Sacred and Profane: Binary Oppositions in Thai Space
...
- **inside / outside** — removing shoes at the threshold.
...
- Bridge to **myth/ideology** (§6.7): binaries often carry hierarchies (high>low) that feel natural but are constructed.
</details>
</div>

<div class="activity" markdown="1">

## Activity 6.4 — Denote, Then Connote
...
Choose **three** Thai cultural signs — e.g. the **elephant** (<em>chang</em>), the **lotus** (<em>dok bua</em>), the colour **gold**, a **garland**, a specific **brand logo**. For each, write:

- **Denotation:** the literal, "dictionary" referent.
...
- Elephant: denotes the animal; connotes national identity, royalty, strength, Buddhism (white elephant), and — commercially — the Chang beer brand. Lotus: denotes the flower; connotes purity, enlightenment, Buddhism. Gold: denotes the metal/colour; connotes wealth, merit, the sacred.
...
- Set up §6.7: connotations that get treated as *natural facts* become **myth**. This activity is the on-ramp to Activity 6.5.
</details>
</div>

<div class="activity" markdown="1">

## Activity 6.5 — Myth Hunt: Deconstruct an Advertisement ★★

<div class="meta">
<span class="tag type">Pair → Whole-class</span>
...
Find **one** Thai advertisement, tourism image, or campaign — a "*Amazing Thailand*" tourism poster, a beer or whisky ad, a skin-whitening product, a nostalgic "authentic village" food ad. Working like Barthes with the Panzani pasta ad:
...
4. **Denaturalise:** who benefits from this myth being taken as natural? What is hidden (industrial production, colourism, labour, commercialisation)?

<details class="notes" markdown="1">
<summary>Instructor notes &amp; discussion</summary>

- This is the chapter's capstone skill and the clearest demonstration of "ideology critique" (§6.7). The skin-whitening example is powerful for denaturalising a beauty myth, but handle it with care and offer the tourism-poster alternative for students who prefer it.
...
- "Amazing Thailand" imagery is ideal: it manufactures an "authentic," timeless Thai-ness ("Thai-ness" as myth) that masks modernity, diversity, and the tourism industry itself.
- Bridge forward to §7.7 (applied/political semiotics) and Ch 7's social semiotics.
</details>
</div>
